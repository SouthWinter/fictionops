...
- [Integration adapters](integrations/README.md), [Codex Skill adapter draft](integrations/codex-skill/README.md), and [API Agent contract draft](integrations/api-agent/README.md) are also available in English.
