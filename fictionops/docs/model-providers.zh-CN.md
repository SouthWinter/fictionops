...
- `examples/agent_runner_openai_chat.py`：用于 OpenAI-compatible Chat Completions 接口。DeepSeek、通义千问/DashScope、Kimi/Moonshot、GLM/智谱、豆包/火山方舟、硅基流动、很多网关和本地服务都适合先走这条。
