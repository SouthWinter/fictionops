...
| --- | --- | --- | --- |
| 0.1.0 Pre-Alpha MVP | Complete locally | `docs/completion-audit-0.1.0.zh-CN.md`, `docs/release-notes-0.1.0.zh-CN.md`, 165 tests in the current regression suite, wheel/sdist builds, source and built-wheel install smoke tests. | External release record if publishing is chosen. |
