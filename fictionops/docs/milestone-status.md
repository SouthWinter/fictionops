...
| --- | --- | --- | --- |
| 0.1.0 Pre-Alpha MVP | Complete locally | `docs/completion-audit-0.1.0.zh-CN.md`, `docs/release-notes-0.1.0.zh-CN.md`, 131 tests, wheel/sdist builds, source and built-wheel install smoke tests. | External release record if publishing is chosen. |
