...
- 139 regression tests and GitHub Actions CI.
...
It currently includes 57 CLI commands, a demo project, migration helpers for old writing folders, OpenAI-compatible runner examples, EPUB export, guided AI setup, and 139 regression tests.
