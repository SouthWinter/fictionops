...
- 133 regression tests and GitHub Actions CI.
...
It currently includes 54 CLI commands, a demo project, migration helpers for old writing folders, OpenAI-compatible runner examples, EPUB export, and 133 regression tests.
