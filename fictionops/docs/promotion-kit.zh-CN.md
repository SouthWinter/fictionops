...
- 131 regression tests and GitHub Actions CI.
...
It currently includes 51 CLI commands, a demo project, migration helpers for old writing folders, OpenAI-compatible runner examples, EPUB export, and 131 regression tests.
