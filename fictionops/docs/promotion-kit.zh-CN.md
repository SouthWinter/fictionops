...
最短录屏或现场演示可以直接使用 [两分钟 Demo 台本](two-minute-demo.zh-CN.md)。下面是更偏宣传场景的长一点版本：
...
- 140 regression tests and GitHub Actions CI.
...
It currently includes 58 CLI commands, a demo project, migration helpers for old writing folders, OpenAI-compatible runner examples, EPUB export, guided AI setup, and 140 regression tests.
