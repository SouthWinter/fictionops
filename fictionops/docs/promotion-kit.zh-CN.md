...
- 158 regression tests and GitHub Actions CI.
...
It currently includes 62 CLI commands, a demo project, typed agent memory, OpenAI-compatible runner examples, EPUB export, guided AI setup, and 158 regression tests.
