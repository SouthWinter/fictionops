...
- persistent issue identity, cross-session merge/reopen, explicit waive/reject decisions, stable author guard create/update/retire history, preservation-aware reviewer withdrawal/counterevidence, anonymous counterevidence packet/key isolation and scoring, deterministic evidence escalation/deduplication, and anonymous information-boundary/character/prose high-risk reviewer fixtures;
