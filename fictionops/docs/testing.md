...
The current suite covers 62 CLI commands and 160 regression tests. It checks:
...
- persistent issue identity, cross-session merge/reopen, explicit waive/reject decisions, preservation-aware reviewer withdrawal/counterevidence, and anonymous information-boundary/character/prose high-risk reviewer fixtures;
